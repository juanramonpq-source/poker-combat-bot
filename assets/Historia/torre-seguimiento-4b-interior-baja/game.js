...
window.PoCoBOTStoryCollisionEditor?.applySceneInteractionPoints("tower-interior", interactables);
...
async function loadAssets() {
  ...
  loadOptionalImage("../Brutos/transparent/XAVOR2-transparent.png", (image) => {
    assets.xavorPortrait = image;
  });
  loadOptionalImage("./assets/chapter/argos-patrol-drone.png", (image) => {
    assets.patrolDrone = image;
  });
